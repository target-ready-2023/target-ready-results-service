...
public class DateTimeConfig {
    public static final int DAY_BEFORE_YEAR_START = 31;
    public static final int MONTH_BEFORE_YEAR_START = 5;
    public static final int DAY_AFTER_YEAR_END = 1;
    public static final int MONTH_AFTER_YEAR_END = 4;
